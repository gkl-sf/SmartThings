...
metadata {
	definition (name: "Securifi Moisture Sensor", namespace: "therevoman", author: "tchoward") {
...
def configure() {
	log.debug("** WTD01 ** configure called for device with network ID ${device.deviceNetworkId}")
...
def parse(String description) {
	log.debug("** WTD01 parse received ** ${description}")
    def result = []        
	Map map = [:]
